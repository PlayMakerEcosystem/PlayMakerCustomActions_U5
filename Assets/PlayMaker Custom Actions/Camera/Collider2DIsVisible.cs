...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Tests if the Collider2D on a GameObject is visible. This will return true even if just a portion of the collider is visible (checks if the Collider2D bounds are outside the camera frustum planes).")]
	public class Collider2DIsVisible : FsmStateAction
	{
		[RequiredField]
