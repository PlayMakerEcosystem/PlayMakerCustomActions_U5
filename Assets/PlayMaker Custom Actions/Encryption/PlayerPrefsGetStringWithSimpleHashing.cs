...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class PlayerPrefsGetStringWithSimpleHashing : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			for(int i = 0; i<keys.Length;i++){
				...
				string tempString = variables[i].Value;
				...
				if (tempString != tempString2) {variables[i].Value = ""; PlayerPrefs.SetString(keys[i].Value, variables[i].Value);}
			}
