...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Set the base offset value of the given NavMeshAgent.")]
	public class NavMeshAgentSetBaseOffset : FsmStateAction
	{
		[RequiredField]
		...
		public override void OnEnter()
		{
			...
			go.GetComponent<NavMeshAgent>().baseOffset = baseOffset.Value;
