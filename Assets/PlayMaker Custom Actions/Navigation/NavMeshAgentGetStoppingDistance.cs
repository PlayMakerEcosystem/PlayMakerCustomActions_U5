...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Get the stopping distance of the current NavMeshAgent's position.")]
	public class NavMeshAgentGetStoppingDistance : FsmStateAction
	{
		[RequiredField]
		...
		public override void OnEnter()
		{
			...
			stoppingDistance.Value = go.GetComponent<NavMeshAgent>().stoppingDistance;
