...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Get the the 'Auto Traverse Offmesh Link' value of the given NavMeshAgent.")]
	public class NavMeshAgentGetAutoTraverseOffMeshLink : FsmStateAction
	{
		[RequiredField]
		...
		public override void OnEnter()
		{
			...
			autoTraverseOffMeshLink.Value = go.GetComponent<NavMeshAgent>().autoTraverseOffMeshLink;
