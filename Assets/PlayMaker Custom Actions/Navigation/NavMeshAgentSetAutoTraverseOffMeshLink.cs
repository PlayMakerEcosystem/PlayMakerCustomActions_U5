...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Set the the 'Auto Traverse Offmesh Link' value of the given NavMeshAgent.")]
	public class NavMeshAgentSetAutoTraverseOffMeshLink : FsmStateAction
	{
		[RequiredField]
		...
		public override void OnEnter()
		{
			...
			go.GetComponent<NavMeshAgent>().autoTraverseOffMeshLink = autoTraverseOffMeshLink.Value;
