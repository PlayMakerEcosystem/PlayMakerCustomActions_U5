...
namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Saves a Screenshot during late update. NOTE: Does nothing in Web Player. On Android, the resulting screenshot is available some time later.")]
	public class TakeScreenshotLateUpdate : FsmStateAction
	{
