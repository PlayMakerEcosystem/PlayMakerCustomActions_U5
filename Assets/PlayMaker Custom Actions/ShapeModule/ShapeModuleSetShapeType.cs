...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Set the Shape type of a particleSystem's ShapeModule ( Shuriken)")]
	public class ShapeModuleSetShapeType : FsmStateAction
	{
		[RequiredField]
		...
		void DoExecute()
		{
			_sm.shapeType = (ParticleSystemShapeType)shapeType.Value;
		}
