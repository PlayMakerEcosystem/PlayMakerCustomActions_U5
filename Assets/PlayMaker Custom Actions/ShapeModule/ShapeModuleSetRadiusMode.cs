...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Set RadiusMode of a particleSystem's ShapeModule ( Shuriken)")]
	public class ShapeModuleSetRadiusMode : FsmStateAction
	{
		[RequiredField]
		...
		void DoExecute()
		{
			_sm.radiusMode = (ParticleSystemShapeMultiModeValue)radiusMode.Value;
		}
